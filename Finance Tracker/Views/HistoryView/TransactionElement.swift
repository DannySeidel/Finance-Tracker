...
struct TransactionElement_Previews: PreviewProvider {
    static var previews: some View {
        VStack {
            Spacer()
            TransactionElement(transaction: HistoryTransaction(id: "1959addc-387b-437c-87d2-776a40e9f509", amount: 9.11, name: "Lunch", category: "Food", dateAndTime: Date.now, repeatId: ""))
                .frame(width: 400, height: 75)
            TransactionElement(transaction: HistoryTransaction(id: "53ef26c9-009b-4b41-ba66-99405bf775d9", amount: -15.73, name: "Dinner", category: "Restaurant", dateAndTime: Date.now, repeatId: ""))
